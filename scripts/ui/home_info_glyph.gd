...
func _draw_shield() -> void:
	...
	draw_line(Vector2(12, 12), Vector2(20, 12), UiFactory.GOLD, 2.0, true)
...
func _draw_swords() -> void:
	for mirrored in [false, true]:
		...
		draw_line(start, finish, UiFactory.SKY, 1.2, true)
	draw_line(Vector2(5, 22), Vector2(11, 28), UiFactory.GOLD, 2.5, true)
	draw_line(Vector2(27, 22), Vector2(21, 28), UiFactory.GOLD, 2.5, true)


func _draw_compass() -> void:
	draw_circle(Vector2(16, 16), 12.0, Color("fff6dd"))
	draw_arc(Vector2(16, 16), 12.0, 0.0, TAU, 32, UiFactory.GOLD, 2.0, true)
	...
	draw_colored_polygon(points, Color(UiFactory.GOLD, 0.48))
...
func _draw_reward() -> void:
	...
	draw_polyline(points, UiFactory.PRIMARY_DARK, 2.0, true)
	draw_line(Vector2(8, 23), Vector2(25, 8), UiFactory.GOLD_LIGHT, 2.0, true)
	draw_line(Vector2(13, 20), Vector2(12, 11), UiFactory.CREAM, 1.4, true)
	draw_line(Vector2(18, 16), Vector2(23, 18), UiFactory.CREAM, 1.4, true)
