...
func _ready() -> void:
	...
	icon_view.position = Vector2(30, 6)
	...
	add_child(icon_view)
	rarity_label = _label(Vector2.ZERO, Vector2.ZERO, 14, HORIZONTAL_ALIGNMENT_LEFT)
	rarity_label.visible = false
	level_label = _label(Vector2(58, 4), Vector2(44, 20), 14, HORIZONTAL_ALIGNMENT_RIGHT)
	name_label = _label(Vector2(6, 47), Vector2(96, 20), 14, HORIZONTAL_ALIGNMENT_CENTER)
	owner_label = _label(Vector2(8, 68), Vector2(92, 18), 14, HORIZONTAL_ALIGNMENT_CENTER)
